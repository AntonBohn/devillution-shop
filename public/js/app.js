...
var slideUpTrigger = document.querySelectorAll('.slide-up-trigger');
slideUpTrigger.forEach(function (t) {
  t.addEventListener('click', function () {
    document.querySelector('#' + t.dataset.slide).classList.toggle('active');
    Array.from(slideUpTrigger).filter(function (i) {
      return i !== t;
    }).forEach(function (s) {
      document.querySelector('#' + s.dataset.slide).classList.remove('active');
    });
  });
});
